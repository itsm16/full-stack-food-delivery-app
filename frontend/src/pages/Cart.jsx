                ...
                <div className='w-[70%] h-[70%] flex flex-col gap-6'>
                  ...
                  <div className='font-bold w-fit' onClick={() => navigate("/login")}>
                    {!currentUser
                      ...
                      : <button className='btn btn-primary text-lg' onClick={() => console.log("token")}>Place Order</button>}
                    {/* <button className='text-black btn' onClick={() => { dispatch(placeOrder({ addedItems })) }}>Cl</button> */}
                  </div>
                </div>
